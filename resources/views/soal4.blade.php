...
@section('title', 'Soal 4')

@section('content')
    <div class="container">
        <div class="card mt-5">
            <div class="p-3 text-white bg-dark rounded shadow-sm card-header">
                <h2 class="mb-0 text-white lh-1">Soal 4</h2>
                <p class="mb-0">Menampilkan daftar karyawan yang saat ini pernah mengambil cuti lebih dari satu
                    kali.</p>
        ...
        new Vue({
            ...
            methods: {
                index() {
                    ...
                    axios.get('{{ url('api/soal4') }}').then(resp => {
