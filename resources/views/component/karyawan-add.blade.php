<div class="modal fade" id="modalKaryawanAdd" tabindex="-1" aria-labelledby="modalKaryawanAddLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalKaryawanAddLabel">Tambah Karyawan</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="formKaryawanAdd" @submit.prevent="karyawanCreate">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nomor_induk" name="nomor_induk" required min="1"
                            max="255" v-model="karyawan.nomor_induk">
                    </div>
                    <div class="mb-3">
